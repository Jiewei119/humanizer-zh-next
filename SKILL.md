...
description: |
  ...
  吸收英文版中的检测模式，并按中文写作习惯重写触发词、示例和修复策略。
...
1. **识别 AI 模式** —— 扫描下列各类模式。
2. **改写，而不是删除** —— 用自然表达替换 AI 腔，并覆盖原文涵盖的全部内容。原文有五段，改写也应有五段；原文分段本身病态时（一句一段、超长段落），以信息量等价为准，不机械对应段落数。
3. **保留原意** —— 保持核心信息不变。
...
改写前先判断文本体裁。不同体裁对语气、结构和事实边界的要求不同，不要用同一套“人味”标准处理所有文本。发布平台也影响口语化上限：技术社区（掘金、V2EX 等）可以更随意，公众号观点文的中性区间更窄，小红书有自己的语料习惯——按实际发布平台微调，不套用同一档语气。
...
下文部分示例为了展示“抽象表达如何变具体”，使用了演示性构造的细节（具体机制、场景、数字等）；其中 #5 的调查来源属于“由模糊归因变具体引用”的演示构造。这些细节只说明改写方向，不能作为真实改写时补写事实的依据：未经核实，一律保留原文的模糊表述或整句删除。处理用户文本时必须遵循上面的体裁矩阵；个人叙事中确有新增时，按“待核实内容”格式逐项列出。

## 语气校准（可选）

如果用户提供了自己的写作样本（过往的文字），先分析样本，再改写：
...
1. **先读样本。** 记录：
   ...
   - 人称代词密度（中文口语常省略“我”“你”，真人代词用量通常低于 AI）
   - 程度副词习惯（“挺”“蛮”“太”）
   - “的”字长定语链（“那个写了这本书的作者”式的多层“的”）

2. **在改写里匹配用户的声音。** 不要只是去掉 AI 模式，而要换成样本里的模式。用户写短句，你就别产出长句；用户用“东西”“事儿”，你就别升级成“要素”“组件”。
...
前面的方法去掉 AI 的坏习惯，这一节补充“像真人”的正面做法，核心一句话：**真人感来自保留，不来自表演。** 作者已有的这些特征先原样保住；确实需要新增时，只用于个人叙事和随笔，且逐项列入“待核实内容”。宁可朴素，不要为了像人加戏——硬塞“人性的复杂”是另一种 AI 腔。技术文档、法律、百科类文本不适用本节（见本节开头的适用范围）。

- **保留详略的不均匀。** 真人写自己感兴趣的部分密不透风，无聊的部分一句带过；AI 把每一节写得一样长、每一点用一样多的力。改写时保住作者的详略偏好，不要替他补齐短板、削平长板。
- **保留有轮廓的模糊。** 真人回忆是“大概一月底，反正那阵子特别冷，我穿着羽绒服”——约数、体感细节和“记不清”自然混在一起。AI 只会给出干净的时间，或者干脆沉默。作者已有的模糊别替他修精确；个人叙事需要补时间感时，用“约数 + 一个具体锚点”的组合，不给假精确。
- **用作者自己的生活做参照系。** “走了差不多五公里，比我们小区门口到地铁站还远一点”比“走了五公里”更像人。距离、价格、人数都可以挂在私人参照上；新增参照系属于“待核实内容”。
- **允许情绪迟到和错位。** 真人往往大事平静、小事破防；听到消息时没感觉，回头收拾东西时才哭。AI 的情绪永远和事件强度匹配。作者不合“应该”的情绪反应，一个字都别改成得体的；新增时同样列入“待核实内容”。
- **允许不体面的真实。** 真人书里有嫉妒、小气、无聊、酸溜溜的小念头；AI 的自我暴露永远体面（“我也有不足”）。作者写了这些，保留原样，不要美化。没有的话也不要凭空加阴暗面——那是表演。
- **保留私人指称。** “我们楼下那家兰州”“老周”“我那台破笔记本”——真人有自己的指称系统，AI 用标准名词。作者怎么叫一个人、一家店、一件东西，就照着用，不要替他规范化。
- **保留对读者的攻防。** “先别急着反驳我”“我知道你觉得这段扯远了”“你大概率不会信”——真人作者会和读者较劲，AI 的读者互动只有礼貌。同样只用于观点和随笔。
- **保留稳定的个人小毛病。** “的地得”混用、固定把“账户”写成“帐户”、反复用的口头词——只要作者一直这样写，这就是指纹。别修，也别主动制造：本技能不做错字，只做保留。
- **书稿和长文：保留章节节奏。** 真人书里核心章两万字、垫章一页纸，标题风格可杂可变，单行短段和千字密段并存，还有不推进主线的闲章；AI 的章章等长、节节三段、标题工整平行。改写长文先看各章长度分布，改写后比原文更均匀就是削平了节奏，恢复；标题跟随作者既有风格，闲章照留，等量覆盖按“章”执行。仅书稿和长文适用；不得把均匀的原文强行改悬殊——那是表演。
- **把骑墙收拢成下注。** AI 的判断永远安全：“一方面……另一方面……”“见仁见智”，全文风险点密度趋近于零。真人写作有赌注：敢给出可被反驳的具体主张，敢孤立（“所有人都说 X，我觉得恰恰相反”），敢承认利益关联（“我在那家公司干过”），敢预判并正面回应真实的异议，也敢让自己的观点变（“我两年前不是这么想的”）。作者的表述骑墙但立场已有倾向时，按他的倾向收拢成形；观点的时间演变照留。边界：不能替作者下注——他没有的立场不要造。
- **保留思考的爪印。** 真人文本里有推理的过程感：自我打断（“等等，我前面说错了”）、当场重算（“不对，应该是 40%”）、排除法可见（“不是 A——试过，不行；也不是 B。最后是 C”）、用词的选择痕迹（“‘噤声’还是‘沉默’想了很久，选了前者，更冷”）。作者已有的爪印一个都别抹平。也别硬造——这是最容易被表演毁掉的一条，假的挣扎一眼假；顺滑本身不算错，但顺滑加上全文无一个风险点，就是 AI 的原貌。
- **保留私人概念系统。** 真人会发明自己的术语并用到底：“我把这种情况叫‘软性加班’”“我认识的人分两种……”。AI 只用标准概念和标准分类。作者的私人命名、私人分类法照用，不要替他规范化成书面语。
...
**改写后：**
> 加泰罗尼亚统计局成立于 1989 年，是当年西班牙向地方下放行政职能、加强区域治理的举措之一。
...
**改写后：**
> 寺庙用了蓝色、绿色和金色，对应的是当地的蓝帽花和墨西哥湾。

### 4. 宣传和广告式语言

**观察：** “领先、卓越、极致、革命性、全方位、沉浸式、护航”；也对应“拥有（夸张用法）、充满活力的、丰富的（比喻）、深刻的、致力于、自然之美、坐落于、位于……的中心、开创性的、著名的、令人叹为观止的、必游之地、迷人的”。
...
*注：这里的调查来源是演示构造。实际处理时，只有用户文本或可核实资料中确有该来源，才能这样写；否则“专家认为”这类模糊归因的正确处理是整句删除，而不是补一个来源。*
...
**改写后：**
> Korattur 面临交通拥堵和水资源短缺，当地正在推进相关应对举措。

## 语言和语法模式

### 7. 过度使用 AI 高频词

**观察：** “赋能、生态、闭环、抓手、底层逻辑、价值沉淀、长期主义、深度融合、全链路、颗粒度、场景化、范式、跃迁”；另一批是英文 2023 年后激增高频词的中文直译（原词如 moreover、delve、crucial、showcase、vibrant）：“此外、契合、至关重要、深入探究、强调、持久、增强、培养、赢得、凸显、交织、错综复杂、关键、格局、举足轻重、展示、织锦（比喻）、证明、彰显、宝贵、充满活力”；近年流行的抽象包装词：“情绪价值、松弛感、氛围感、心智（占领用户心智）、体感、维度（“多个维度”式用法）、赛道、痛点、护城河”。

**时效性：** 词表反映 2023—2026 年的语料。模型迭代会带来新的高频词：遇到成片出现、含义空泛的新抽象词，按同样标准处理，不要被词表年限束缚。
...
**问题：** “不只是 X，更是 Y”这种结构偶尔有用，但被 LLM 过度使用，连续出现会像在刻意制造深度。句尾的否定碎片则像在补一句广告词，而不是一个完整的句子。
...
**改写后：**
> 本书讲了大爆炸、恒星的诞生与死亡、宇宙网，以及关于暗物质的现有理论。
...
**改写后：**
> 产品在第三季度发布。用户更喜欢简单。下一步：安排一次后续会议。
...
**统一方向（大陆规范）：** 简体中文默认按 GB/T 15834 处理：引号用弯引号“”（内层用‘’），不用直引号 " 和直角引号「」；若用户原文整体使用「」体系（台湾、香港习惯），跟随原文并保持全文一致。中西文之间的空格（盘古之白）可加可不加，全文统一即可。数字用法同类别统一：叙述性时间和约数用汉字（三年前、大约三十秒），精确计量与编号用阿拉伯数字（28 路、30%），同一文本内不混用两种风格表达同一类事物。繁体文本保持原体系不转换，其腔调与高频词判断也不套用本 skill 的简体词表。
...
**观察：** “真正的问题是”“归根结底”“本质上”“核心在于”“底层逻辑是”“这背后的本质是”“关键不在于……而在于……”“真正的解法不是 X 而是 Y”“问题不在 A 而在 B”；“厘清/打破……的因果链”“这背后的因果链”（推理模型兴起后激增；逻辑学、学术文本里的“因果链”是规范术语，不在此列）。
...
**观察：** 连续短句：“然后，一切改变了。没有预兆。没有退路。旧规则失效了。” 或段尾突然出现像海报标语、推文金句、pull-quote 的句子。也留意戏剧化比喻：“被钉在耻辱柱上”“钉死在……上”“被钉进历史”（近年中文 AI 高频；工程口语里中性的“把参数钉死”不在此列）。
...
**观察：** “X 是 Y 的语言”“X 不是工具，而是一面镜子”“效率会成为陷阱”“数据是新的货币”“……的架构”“……的货币”；“账”的隐喻：“算一笔账”“这笔账怎么算都……”“心里那本账”“时间会翻/历史的账本”（真在讲财务账务时“账本”是字面义，不在此列）。
...
**观察：** “说实话？”“老实讲，”“你知道吗？”“问题来了，”“讲真，”单独作为钩子。
...
以下五类在 `blader/humanizer` 等英文版本中没有对应条目，全部来自中文写作环境自身的观察。判断方式和全文一致：单次出现不是痕迹，成片出现、让文本空泛或不像当前作者时才处理；公文、法律文书的固有套式是文体要求，不按本节处理（见「检测指南」）。

### 34. 翻译腔结构残留

**观察：** “……之一”高频出现（“最重要的因素之一”“最受欢迎的选择之一”）；“作为 + 名词”开头的句子（“作为一款工具，它……”）；“对……而言”“对于……来说”堆叠。

**问题：** 中文“之一”本用于需要严谨限定的场合，真人使用频率很低；LLM 把英文的 "one of the..." 逐句直译进来，一篇文章能撒十几个“之一”。“作为 X，它……”是把英文同位语 "As a X, it..." 硬套进中文，中文更自然的写法是直接以主语开头。

**修复：** “之一”能删就删，确需保留时全文最多一两次。“作为……”开头的句子把主语提前，修饰融进正文。

**改写前（应用场景）：**
> 作为一款笔记软件，它最大的优势之一就是支持双向链接，这对知识工作者来说非常重要。

**改写后：**
> 这款笔记软件支持双向链接，对知识工作者尤其有用。

### 35. 公文腔万能动词和套式开头

**观察：** “进行分析、进行处理、进行优化、进行梳理”；“随着……的不断深入/发展/推进”开头；“进一步 + 动词”高频（“进一步提升”“进一步完善”）；“围绕……开展”。

**问题：** “进行”把现成动词包装成名词再还回去，拉长句子不加信息；“随着……”和“进一步”是模仿“正式感”的固定套件，在方案、报告类文本里密度极高。

**修复：** “进行 X”直接还原成动词 X；“随着……”从句能删就删；“进一步”只在真有递进关系时保留。

**改写前（应用场景）：**
> 随着业务的不断发展，我们对数据管理流程进行了优化，进一步提升了查询效率。

**改写后：**
> 业务规模变大后，我们优化了数据管理流程，查询快了近一半。

### 36. 四字格与成语密度

**观察：** “行之有效”“卓有成效”“与此同时”“不言而喻”等四字结构扎堆；旅游、营销文案里“美不胜收、流连忘返、叹为观止、回味无穷”连环出现。

**问题：** 四字格是中文的天然成分，真人会用但稀疏分布；LLM 几乎每句都想凑一个，形成工整的节奏，读起来像套话拼盘。单个四字格不是问题，密度才是。政府公文、法律文书的四字格密度本来就高，属文体使然，不按本条处理。

**修复：** 保留最有表现力的一两个，其余拆成自然表述。检验标准：换成大白话后若更自然，就换。

**改写前（应用场景）：**
> 这家老店承载了几代人的记忆，手艺精湛令人叹为观止，点心更是回味无穷，让人流连忘返。

**改写后：**
> 这家老店做了三代人，点心的手艺一直没走样。

### 37. 双联对仗排比

**观察：** “既……又……”“不仅……还……”“既保证了……又兼顾了……”“从 X 走向 Y，从 A 迈向 B”。

**问题：** 与 #9 的“不是……而是……”相对，这是正面方向的双联。单个出现很正常，但 LLM 会让每个结论都长出两翼。中文名篇里的对仗是精心设计的，AI 文本里的对仗是默认姿势。

**修复：** 拆成两个短句，或只留更实质的半句，把另一半写具体。

**改写前（应用场景）：**
> 这套方案既保证了数据安全，又兼顾了使用便捷，让团队从混乱走向有序，从低效走向高效。

**改写后：**
> 这套方案对数据做了分级：核心数据加密存储，日常数据直接调用。团队交接材料的时间从半天缩到半小时。

### 38. 被字句直译

**观察：** “文件被保存”“配置被更新”“被广泛使用”“被认为是”——说明文和技术文档里的“被 + 动词”密度异常。

**问题：** 中文“被”字句天然带遭受、不如意的色彩；规范的系统行为描述用“已保存”“已更新”或以系统为主语。LLM 把英文被动语态逐字搬进中文，读起来像说明书翻译稿。法律文本里的“被侵权”“被处罚”是必要用法，不受本条约束。

**修复：** 系统行为用“已 + 动词”或让系统当主语（“系统会自动保存”）；真正强调遭受义时才用“被”。

**改写前（应用场景）：**
> 所有修改会被自动保存，历史版本可以被随时恢复，配置文件不需要被手动备份。

**改写后：**
> 所有修改会自动保存，历史版本随时可以恢复，配置文件不需要手动备份。
...
- **正式或学术的词汇。** AI 滥用的是*特定*一批花哨词（见 #7），不是所有大词。别因为“遑论”“构成要件”或英文的 ostensibly 这类词听着高级就把它们抹平。
...
- **写于 2022 年 11 月底 ChatGPT 公开发布之前的文本。** 更早的 GPT-3 等模型虽已可用，但使用面很窄；除特殊情况外，这类文本几乎可以肯定不是 AI 写的。
- **有轮廓的模糊。** “大概三月，反正樱花开的时候”——约数、体感细节和“记不清”混在一起的记忆，AI 给不出这种质感（见“真人写书感的进阶规则”）。
- **情绪的迟滞与错位。** 大事平静、小事破防，反应不合事件的“应该”强度。
- **私人参照系和私人指称。** 用自己的生活做标尺，对人和店有私下的叫法。
- **稳定的个人小毛病。** “的地得”混用、固定的个人写法——只要稳定，就是指纹。
- **可被反驳的具体主张。** 作者把判断押上去、错了要负责的那种；与之配套的孤立立场、利益关联的坦诚和观点的时间演变。AI 的每句话都安全，全文找不到一个愿意为之负责的断言。
...
1. **通读原文。** 根据「体裁决策矩阵」判断文本体裁，并从文本本身推断目标读者，**标出所有命中的模式**，并确认该体裁是否允许新增叙事细节。书稿和长文先看章节节奏——各章长度分布、标题风格、闲章——记住它们，避免改写时削平。
2. **写初稿。** 先处理空泛、虚高、模板化的地方，再处理句式、标点、标题和填充词。检查初稿：朗读是否通顺，句长有没有变化，是不是优先用了具体细节和简单判断句（能用“是”就用“是”），语域是否合适，信息是否与原文等量覆盖（发现压缩或遗漏，先补齐再往下走）。个人叙事中如有新增内容，写作时同步记录，不要等到最后凭印象回想。
...
交付前可选用 1-10 分快速检查六个维度（满分 60），总分低于 42（约七成）时再改一轮：
...
| 真实感 | 是否有具体行动者、具体细节和真实取舍？判断是否敢下注（有可被反驳的具体主张），还是句句骑墙？ |
...
>
> 我坐了 28 路电车，因为人人都说要坐 28 路。车很挤、很慢，车上多半是在拍同几个转角的人。贝伦区那家 Pastéis de Belém 我也去了，蛋挞趁热吃确实好。
>
...
>
> 人人都说要坐 28 路，我就坐了，挤在一个陌生人的背包上四十分钟，旁边三个旅行团在拍同一个转角。下次我宁愿走这条线，或者赶在早饭前去。至于蛋挞，贝伦区那家 Pastéis de Belém 名副其实，趁热吃的那三十秒，我有点明白为什么有人会为了一口点心专门安排一趟行程。
>
...
- 新增了趁热吃蛋挞时持续约三十秒的感受，以及为一口点心专门安排行程的联想；蛋挞经历保留为原文的贝伦区 Pastéis de Belém，未替换原有经历。
- 新增了离开主广场两个街区后的晾衣绳、缺角瓷砖、开窗和老人看球等场景细节。
- 新增了在城堡排队时间长于参观时间、行程只有两天时会放弃城堡的判断。
- 新增了下次选择春天、带更适合步行的鞋，以及喜欢城市“不迁就人”这一特点的偏好。

**改动小结：**
- 保留了第一人称的旅行随笔和原文的既有经历——山坡、28 路电车、贝伦区的蛋挞、安静的巷子、城堡都还在，新增细节挂在原有经历上，没有替换它们，也没有砍成梗概。
- 去掉了聊天腔的框架、意义拔高、宣传腔、刻意的热情、成串的戏剧化破折号（终稿保留了一处正常的插入语）、三段式节奏、通用的乐观结尾和表情符号。
